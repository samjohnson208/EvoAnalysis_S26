...
#SBATCH -e /project/evoanalysis/sjohn208/std/err_trim_%A_%a.err   # EDIT TO YOUR DIRECTORY IN evoanalysis (or wherever else)
#SBATCH -o /project/evoanalysis/sjohn208/std/std_trim_%A_%a.out   # EDIT TO YOUR DIRECTORY IN evoanalysis (or wherever else)
...
RAW_DIR="/project/evoanalysis/sjohn208/challenge3/*.fastq"
OUTDIR="/project/evoanalysis/sjohn208/fastq_to_vcf_exercise/out_fastp"
REPORTDIR="/project/evoanalysis/sjohn208/fastq_to_vcf_exercise/out_fastp/fastp_reports"
# ADAPTERS="/PATH/TO/adapters.fa"   # if using a file of adapters not just defaults

# Ensure output directories exist
# mkdir -p "$OUTDIR" "$REPORTDIR" (already dun did this, but i like this approach)
